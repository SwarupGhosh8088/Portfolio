  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 md:gap-4">
        ...
        <a
          href={resume}
          download="Swarup_Ghosh_Resume.pdf"
          className="bg-blue-600 h-10 flex items-center justify-center gap-2 px-3 md:w-30 rounded-xl text-blue-50 hover:text-zinc-900 font-bold hover:bg-blue-700 text-sm md:text-base"
        >
      ...
      {open && (
        ...
        >
          ...
          <Link to="/cp" onClick={() => setOpen(false)}>
            Competative Programming
          </Link>
